...
- [ ] On her go, write the program goal to `GOAL.md` in the run directory with this exact text, and re-read it each tick. "<The plan path, the PR ids in order, the verification rule, who merges, and the done condition.>"
