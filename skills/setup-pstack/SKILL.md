---
name: setup-pstack
description: Configure which models pstack uses per role. Writes a config file that overrides the skill defaults. Use for /pstack:setup-pstack, "configure pstack models", or changing pstack's model choices.
---
